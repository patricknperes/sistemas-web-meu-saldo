    ...
    return (
        <section
            className={`
                ...
                ${embedded ? "min-h-[680px] rounded-2xl border border-border" : "min-h-screen min-h-dvh"}
                ${className}
            `}
        >
            <div
            ...
            >
                {hasAside ? (
                    <aside className="hidden min-w-0 overflow-hidden rounded-2xl bg-primary p-8 text-primary-foreground lg:flex lg:flex-col lg:justify-between">
                        {aside}
                    </aside>
                ) : null}
                ...
                >
                    ...
                    <div className="flex min-h-0 flex-1 items-center justify-center py-5 sm:py-8">
                        <div
                            className={`
                                w-full rounded-2xl border border-border bg-surface p-5 shadow-card
                                sm:p-7
