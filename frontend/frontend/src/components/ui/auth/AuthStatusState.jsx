...
function AuthStatusState({
    ...
    return (
        ...
        >
            ...
            <h2
                className={`
                    mt-4 font-extrabold tracking-heading text-foreground
            ...
            {detail ? (
                <div className="mx-auto mt-4 max-w-md rounded-lg border border-border bg-surface-subtle px-3 py-2.5 text-body-sm font-bold text-foreground-soft">
                    {detail}
                </div>
            ) : null}
