            ...
            {view === "months" ? (
                <>
                    <div className="mb-4 flex items-center justify-between gap-3">
                        ...
                        <button
                            type="button"
                            className="rounded-lg px-3 py-2 text-body-sm font-bold text-foreground outline-none transition-colors hover:bg-surface-hover focus-visible:ring-4 focus-visible:ring-primary/15"
