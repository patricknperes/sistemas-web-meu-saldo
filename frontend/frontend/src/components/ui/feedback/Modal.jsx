                    ...
                    <div className="fixed inset-0 z-[100] flex items-end justify-center p-0 sm:items-center sm:p-6">
                        ...
                        <motion.div
                            ...
                            className={mergeClassNames(
                                "relative z-10 flex max-h-[calc(100dvh-1rem)] w-full flex-col overflow-hidden rounded-t-2xl border border-border bg-surface-elevated shadow-dialog sm:max-h-[calc(100dvh-3rem)] sm:rounded-2xl",
