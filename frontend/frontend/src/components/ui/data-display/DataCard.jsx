        ...
        return (
            <Component
                ...
                className={mergeClassNames(
                    ...
                    canInteract
                        ? "cursor-pointer hover:border-primary/25 hover:bg-surface-elevated hover:shadow-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/25"
                        : "",
                    className
                )}
                onClick={onClick}
        ...
        <div className={mergeClassNames("flex min-w-0 items-start gap-3", className)}>
            ...
            <div className="min-w-0 flex-1">
                <div className="flex min-w-0 items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                        {title ? (
                            <h3 className="truncate text-card-title font-bold text-foreground">
                                {title}
                            </h3>
                        ) : null}
                    ...
                    {value ? (
                        <strong className={mergeClassNames(
                            "numeric-value shrink-0 text-body-sm font-extrabold text-foreground",
                            valueClassName
                        )}>
                            {value}
                        </strong>
