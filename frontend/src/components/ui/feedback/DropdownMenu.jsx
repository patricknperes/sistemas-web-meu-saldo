    ...
    return (
        <button
            ...
            className={mergeClassNames(
                "flex w-full items-center gap-3 rounded-control px-3 py-2 text-left text-body-sm font-medium transition-colors focus:outline-none focus-visible:bg-surface-hover",
                danger
...
function DropdownMenuLabel({ children }) {
    return (
        <p className="px-3 pb-1.5 pt-2 text-overline font-label uppercase tracking-overline text-muted-foreground">
            {children}
        </p>
    );
}
